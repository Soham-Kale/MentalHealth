...
const Navbar = () => {
  ...
  return (
    <nav className="w-full py-3.5 px-6 md:px-12 flex justify-between items-center bg-slate-200 shadow-lg relative">
      ...
      {/* Desktop Menu */}
      <div className="hidden md:flex items-center gap-9">
        <Link to="/home" className="font-medium hover:text-purple-700 transition duration-300">
          HOME
        </Link>        
        ...
        <Link to="/" className="bg-purple-700 text-white px-6 py-2 rounded-md font-medium hover:bg-purple-600 transition duration-300">
          LOGIN
        </Link>
      </div>
        ...
        <>
          ...
          <div className="absolute top-16 left-0 right-0 bg-white z-50 shadow-lg rounded-b-lg md:hidden transition-transform duration-300 transform scale-y-100 origin-top">
            <div className="flex flex-col p-6 gap-4">
              ...
              <Link to="/" className="bg-purple-700 text-white px-6 py-2 rounded-md font-medium text-center hover:bg-purple-600 transition duration-300" onClick={handleLinkClick}>
                LOGIN
              </Link>
            </div>
          </div>
